<nav class="border-[#1E1E2C] border-2 w-full py-[18px] ">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex justify-between">
        ...
        <ul class="text-[#C3C3D1] flex items-center gap-4 text-[16px]">
            <li class="hover:font-semibold cursor-pointer"><a href="/project">Anunciar um projeto</a></li>
            <li class="hover:font-semibold cursor-pointer"><a href="/">Procurar um projeto</a></li>
            <li class="hover:font-semibold cursor-pointer"><a href="/about">Como funciona?</a></li>
        </ul>
